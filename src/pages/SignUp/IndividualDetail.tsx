              ...
              <div className="col-span-2 space-y-2">
                ...
                <div className="flex gap-3">
                  <Select
                    ...
                    variant={"flat"}
                    renderValue={(items) => `+${items[0]?.props?.value}`}
                    onChange={(value) => setFieldValue("mobileCountryCode", value)}
                  >
                    {countryCodes.map((code, index) => (
                      <SelectItem key={index}>{code}</SelectItem>
                    ))}
                  </Select>
                ...
                {errors.mobileCountryCode && touched.mobileCountryCode && (
                  <p className="text-red-500 text-sm mt-1">{String(errors.mobileCountryCode)}</p>
                )}
                {errors.mobileNumber && touched.mobileNumber && (
                  <p className="text-red-500 text-sm mt-1">{String(errors.mobileNumber)}</p>
                )}
              </div>
              <div className="col-span-2 space-y-2">
                ...
                {errors.idNumber && touched.idNumber && (
                  <p className="text-red-500 text-sm mt-1">{String(errors.idNumber)}</p>
                )}
              </div>
              <div className="col-span-2 space-y-2">
              ...
              <div className=" col-span-2 space-y-2">
                ...
                <div>
                  ...
                  {errors.acceptTerms && touched.acceptTerms && (
                    <p className="text-red-500 text-sm mt-1">{String(errors.acceptTerms)}</p>
                  )}
                </div>
                <div>
                  <input
                  ...
                  {errors.acceptRulebook && touched.acceptRulebook && (
                    <p className="text-red-500 text-sm mt-1">{String(errors.acceptRulebook)}</p>
                  )}
                </div>
              </div>
