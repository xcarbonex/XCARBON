        ...
        {({
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4">
            ...
            <div className="col-span-2 md:col-span-1">
              <label
                htmlFor="uploadFile1"
                className=" text-[#949494] font-semibold  rounded p-[30px] flex flex-col items-center justify-center cursor-pointer border-2 border-[#363638] border-dashed mx-auto"
              >
            ...
            <div className="col-span-2 md:col-span-1">
              <label
                htmlFor="uploadFile2"
                className=" text-[#949494] h-full font-semibold  rounded p-[30px] flex flex-col items-center justify-center cursor-pointer border-2 border-[#363638] border-dashed mx-auto"
              >
