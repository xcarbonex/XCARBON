      ...
      <div className="space-y-5 text-black dark:text-[#FFFFFF]/80">
          ...
          <div className="flex flex-col md:flex-row items-center gap-5">
            <p className="text-sm text-black dark:text-[#949494] leading-relaxed">
              ...
              <ul className=" mt-2 space-y-2">
                <li>
                  <b>Project Development:</b> Identifying and designing projects that reduce or
                  remove greenhouse gas emissions (e.g., renewable energy, reforestation).
                </li>
                <li>
                  <b>Validation:</b> Independent third-party assessment to ensure the project meets
                  a recognized carbon standard and its methodologies are sound.
                </li>
                <li>
                  <b>Monitoring:</b> Continuous measurement and reporting of actual emission
                  reductions achieved by the project.
                </li>
                <li>
                  <b>Verification:</b> Another independent third-party audit to confirm the reported
                  emission reductions are accurate and meet the standard's requirements.
                </li>
                <li>
                  <b>Issuance:</b> Once verified, carbon credits are issued by a registry, each
                  representing one tonne of CO2e reduced or removed.
                </li>
                <li>
                  <b>Trading:</b> Credits can be bought and sold on compliance or voluntary markets.
                </li>
                <li>
                  <b>Retirement:</b> Credits are permanently removed from circulation once used to
                  offset emissions, preventing double-counting.
                </li>
              </ul>
            </p>
          </div>
        ...
        <div className="grid shadow-xl p-4 border rounded-custom dark:bg-[#191919] bg-[#FDFDFB]">
          ...
          <ul className=" text-sm text-black dark:text-[#949494] leading-relaxed space-y-2">
            <li>
              <b>Environmental Impact:</b> Directly contributes to the reduction of global
              greenhouse gas emissions, combating climate change.
            </li>
            <li>
              <b>Economic Incentives:</b> Provides financial incentives for businesses and
              organizations to adopt sustainable practices and invest in green technologies.
            </li>
            <li>
              <b>Sustainable Development:</b> Supports projects that often have co-benefits such as
              biodiversity conservation, improved public health, and job creation in local
              communities.
            </li>
            <li>
              <b>Regulatory Compliance:</b> Helps companies meet mandatory emission reduction
              targets imposed by governments and international agreements.
            </li>
            <li>
              <b>Enhanced Reputation:</b> Improves corporate image and demonstrates a commitment to
              environmental stewardship, appealing to conscious consumers and investors.
            </li>
          </ul>
        </div>
