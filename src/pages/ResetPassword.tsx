  ...
  return (
    ...
    >
      <div className="max-w-md w-full space-y-4 bg-secondary p-8 border text-tbase rounded-lg shadow-lg">
        ...
        <div>
          <h2 className="mt-1 text-center text-3xl font-extrabold ">Reset Your Password</h2>
          <p className="mt-2 text-center text-sm ">Please enter your new password below</p>
        </div>
