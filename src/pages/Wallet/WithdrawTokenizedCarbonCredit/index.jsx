      ...
      <div className="space-y-6">
        ...
        <section className="bg-[#FDFDFB] dark:bg-[#141517] border border-[#363638] rounded-xl p-6">
          <div className="flex items-center gap-4 border-b border-[#363638] pb-4 mb-6">
            ...
            <div>
              ...
              <Typography variant="caption" className="text-[#949494] dark:text-white/30">
          ...
          <div className="space-y-4">
            <Typography variant="subtitle2">Available Tokenized Assets</Typography>
            ...
            <div className="bg-[#E2E6E5] dark:bg-[#363638]/50 rounded-lg p-4">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <Typography variant="caption" className="text-[#949494]">VCS-123456-2022</Typography>
                </div>
              ...
              <div className="flex gap-3 items-center p-3 border border-[#FFA621] bg-white/[8%] rounded-lg">
                ...
                <Typography variant="body2">
                  <strong>Notice:</strong> This asset is currently listed for sale. Delisting will cancel the active sale listing.
                </Typography>
              </div>
            </div>
          </div>
        ...
        <section className="bg-[#FDFDFB] dark:bg-[#141517] border border-[#363638] rounded-xl p-6">
          <div className="flex items-center gap-4 border-b border-[#363638] pb-4 mb-6">
            ...
            <div>
              <Typography variant="h5">Asset Status During Withdrawal</Typography>
              <Typography variant="caption" className="text-[#949494] dark:text-white/30">
          ...
          <div className="bg-[#E2E6E5] dark:bg-[#363638]/50 rounded-lg p-4">
            ...
            <Typography variant="body2" className="text-[#949494] mb-4">
              During the withdrawal process, your asset will be placed in escrow and cannot be traded or transferred. 
              This ensures the integrity of the carbon credit registry update.
            </Typography>
        ...
        <section className="bg-[#FDFDFB] dark:bg-[#141517] border border-[#363638] rounded-xl p-6">
          ...
          <div className="space-y-6">
            <div>
              <Typography variant="subtitle2" className="mb-2">Reasons for Withdrawal</Typography>
              <SelectField options={reasonsWithdrawl} isClearable />
            </div>

            <div className="bg-[#E2E6E5] dark:bg-[#363638]/50 rounded-lg p-4">
              <Typography variant="h6" className="mb-4">New Owner Information</Typography>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {inputFields.map((field, index) => (
                  <div key={index}>
                    <Typography variant="subtitle2" className="mb-2">{field.label}</Typography>
              ...
              <div className="mt-4">
                <Typography variant="subtitle2" className="mb-2">Contact E-mail</Typography>
                <Input placeholder="abcdef@gmail.com" type="email" />
              </div>

              <div className="mt-4">
                <Typography variant="subtitle2" className="mb-2">Additional Notes</Typography>
                <textarea
        ...
        <section className="bg-[#FDFDFB] dark:bg-[#141517] border border-[#363638] rounded-xl p-6">
          <Typography variant="h6" className="mb-2">Upload Documentation (Optional)</Typography>
          <Typography variant="caption" className="text-[#949494] block mb-4">
          ...
          <label className="block w-full p-6 border-2 border-[#363638] border-dashed rounded-lg cursor-pointer hover:bg-[#E2E6E5] dark:hover:bg-[#363638]/30 transition-colors">
            <div className="flex flex-col items-center gap-2">
              ...
              <Typography variant="body2" className="text-center text-[#949494]">
        ...
        <div className="flex items-start gap-3">
          <input
            type="checkbox"
            className="mt-1.5 accent-tbase"
          />
          <Typography variant="body2">
            I confirm this asset will be permanently removed from circulation and this action cannot be reversed.
          </Typography>
        </div>

        {/* What Happens After */}
        <section className="bg-[#FDFDFB] dark:bg-[#141517] border border-[#363638] rounded-xl p-6">
          <Typography variant="h6" className="mb-6">What happens after withdrawal</Typography>
