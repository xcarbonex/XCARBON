...
import { Drawer, Input, Typography, Button, SelectField, useToast } from "@/components";
...
const WithdrawDrawer: React.FC<WithdrawDrawerProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Drawer isOpen={isOpen} onClose={onClose} title="Withdraw Tokenized Carbon Credit" size="xl" anchor="right">
      <Formik<WithdrawFormValues>
        ...
        onSubmit={(values: WithdrawFormValues) => {
          ...
          toast.success("Withdrawal Initiated", "Your request is being processed.");
          onClose();
        }}
      >
              ...
              <div className="bg-[#E2E6E5] dark:bg-[#363638]/50 rounded-lg p-4 mt-4">
                ...
                <div className="flex gap-3 items-center p-3 border border-[#FFA621] bg-white/[8%] rounded-lg mt-4">
                  ...
                  <Typography variant="body2">
                    <strong>Notice:</strong> This asset is currently listed for sale. Delisting
                    will cancel the active sale listing.
                  </Typography>
                </div>
              </div>
            </section>
