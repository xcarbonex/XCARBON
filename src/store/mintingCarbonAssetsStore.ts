...
import type { MintCarbonCreditInput, MintCarbonCreditResponse, GasFees } from "@/types/api";
...
interface MintingCarbonAssetsState {
  ...
  loading: boolean;
  error: string | null;
  saveMintCarbonCredit: (_payload: MintCarbonCreditInput) => Promise<void>;
  fetchGasFees: (_quantity: number) => Promise<void>;
  clearError: () => void;
}
