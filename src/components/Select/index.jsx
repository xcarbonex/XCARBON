...
const SelectField = ({ options, defaultValue, onChange, placeholder = 'Select an option...', ...rest }) => {
  ...
  const customStyles = {
    control: (provided, state) => ({
      ...
      boxShadow: state.isFocused ? '0 0 0 1px var(--border)' : 'none', // Matches focus:ring-1
      '&:hover': {
        borderColor: 'var(--border)',
      },
